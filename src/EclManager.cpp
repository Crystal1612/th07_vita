    ...
    for (;;)
    {
        ...
        if ((instr->skipInstrOnDifficulty & g_GameManager.difficultyMask) != 0)
        {
            ...
            case 0x2c: {
                ...
                else
                {
                    i32 local_3c0 = (instr->paramMask & 4) == 0
                                        ? instr->args[2].i
                                        : GetVarValue(enemy, instr->args[2].i);
                    local_3c4 = GetFloatVarValue(g_EnemyManager.bosses[local_3c0],
                                                 instr->args[1].f);
                }
            ...
            case 0x55: {
                ...
                if (enemy->lasers[local_594] != NULL)
                {
                    ...
                    enemy->lasers[local_8]->angle = utils::AddNormalizeAngle(
                        enemy->lasers[local_8]->angle, local_598);
                }
                break;
            }
            case 0x56: {
            ...
            case 0x5f: {
                ...
                g_AnmManager->SetAndExecuteScript(
                    &enemy->primaryVm, g_AnmManager->scripts[local_4e0 + 0x900]);
                break;
            }
            case 0x60: {
            ...
            case 0x69: {
                i32 local_664 = (instr->paramMask & 1) == 0
                                    ? instr->args[0].i
                                    : GetVarValue(enemy, instr->args[0].i);
                g_SoundPlayer.PlaySoundByIdx(local_664, 0);
                break;
            }
            case 0x6a: {
